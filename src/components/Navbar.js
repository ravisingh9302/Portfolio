...
const Navbar = () => {
  ...
  return (
    <div className=" w-full h-[65px] fixed top-0 shadow-xl shadow-[#2C3285]/50  bg-transparent backdrop-blur-md z-50 lg:px-10 ">
      <div className=" w-full h-full flex flex-row items-center justify-between m-auto px-[10px]">
        ...
        <Link href="/" className="h-auto w-auto flex flex-row items-center" aria-label="Home">
          <Image
            ...
            height={30}
            quality={100}
            className="cursor-pointer hover:animate-slowspin rounded-full border border-gray-800 h-auto w-auto"
          />
